...
def get_weather(city):
    """!@brief Получение погоды в формате JSON.

    @param city - наименование города на английском языке
    @warning данный ключ не работает
    @bug сервер нужно подключать через VPN
    @todo передавать ключ как-то по другому
    """
